...
const sidebarRowLeadingInsetClass = "pl-3"
const sidebarRowContentXClass = `${sidebarRowLeadingInsetClass} pr-2`
const sidebarRowXClass = `${sidebarRowFrameXClass} ${sidebarRowContentXClass}`
const sidebarSessionRowXClass = `mr-1 ${sidebarRowLeadingInsetClass} pr-1`
const sidebarSessionDragPreviewXClass = "px-3"
const sidebarRightActionRowXClass = `${sidebarRowFrameXClass} ${sidebarRowLeadingInsetClass} pr-1`
