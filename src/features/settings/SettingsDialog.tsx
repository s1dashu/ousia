...
function Dialog({ ...props }: DialogPrimitive.Root.Props) {
  return <DialogPrimitive.Root data-slot="settings-dialog" {...props} />
}

function DialogTrigger({ ...props }: DialogPrimitive.Trigger.Props) {
  return (
    <DialogPrimitive.Trigger data-slot="settings-dialog-trigger" {...props} />
  )
}

function DialogPortal({ ...props }: DialogPrimitive.Portal.Props) {
  return (
    <DialogPrimitive.Portal data-slot="settings-dialog-portal" {...props} />
  )
}

function DialogClose({ ...props }: DialogPrimitive.Close.Props) {
  return <DialogPrimitive.Close data-slot="settings-dialog-close" {...props} />
}
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            data-slot="settings-dialog-close"
            render={
              <Button
                variant="ghost"
...
function DialogFooter({
  ...
  return (
    <div
      data-slot="settings-dialog-footer"
      className={cn(
