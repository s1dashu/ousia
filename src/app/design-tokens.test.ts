...
describe("design token boundaries", () => {
  ...
  it("uses the Nucleo icon system throughout the Sidebar", () => {
    ...
    const glassIcons = readSource("src/components/icons/glass-icons.ts")
    ...
    expect(glassIcons).toContain('from "nucleo-glass"')
    expect(sidebar).toContain("icon: GlassNewTask")
    expect(sidebar).toContain("icon: GlassSearch")
    expect(sidebar).toContain("icon: GlassExtensions")
    expect(sidebar).toContain("ousia-glass-icon")
  ...
  it("matches the borderless Composer surface to the Sidebar", () => {
    ...
    expect(chat).toContain("GlassComposerSettings")
    expect(chat).toContain("ousia-glass-icon")
