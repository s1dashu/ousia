...
- Global shadcn semantic tokens match the neutral `bIkeymG` Vega preset.
  ...
  `5949ecc7d9a3f87aff755e12e6b69935d967ddb8`. Gray is the default for new app
  state; persisted user palette choices are not overwritten. Mist remains an
  optional palette adapted from Miki commit
  `9ad986812f151b6a5c2811e7544efcaa4fdea27b`.
