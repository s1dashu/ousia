...
- The Tauri user-facing product and packaged application name is `Pi`. Keep the internal `pi-gui` crate/package names, bundle identifier, data directories, log filename, environment variables, and existing PATH ownership marker stable for upgrade compatibility.
