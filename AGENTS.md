...
- Future Electron tags must use an explicit product prefix such as `electron-v0.1.33`. Future Tauri tags, if any, must use `tauri-v...`; do not return to ambiguous shared `v...` tags.
